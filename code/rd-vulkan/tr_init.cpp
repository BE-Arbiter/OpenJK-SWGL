...
void R_Register( void )
{
	...
	r_ssao								= Cvar_Get("r_ssao",							"0",						CVAR_ARCHIVE_ND | CVAR_LATCH, "Screen-space ambient occlusion over the G-buffer: 0 = off, 2 = GTAO. Mode 1 is reserved for a cheaper method and is not implemented. Requires r_depthPrepass 1");
