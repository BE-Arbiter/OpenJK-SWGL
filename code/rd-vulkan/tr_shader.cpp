...
shader_t *R_FindShader( const char *name, const int *lightmapIndex, const byte *styles, qboolean mipRawImage )
{
	...
	//
	// Neither FindShaderInShaderText() nor ParseShader() open their own
	// parse session (unlike code/rd-vanilla's ParseShader, which does) --
	// wrap them here so COM_ParseExt() always has an active session,
	// regardless of whether a caller further up already opened one.
	{
