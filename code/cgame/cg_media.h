...
//Chunks
	...
	qhandle_t	redElectricBodyShader;
	qhandle_t	redElectricBody2Shader;
	qhandle_t	orangeElectricBodyShader;
	qhandle_t	orangeElectricBody2Shader;
	qhandle_t	yellowElectricBodyShader;
	qhandle_t	yellowElectricBody2Shader;
	qhandle_t	greenElectricBodyShader;
	qhandle_t	greenElectricBody2Shader;
	qhandle_t	purpleElectricBodyShader;
	qhandle_t	purpleElectricBody2Shader;
	qhandle_t	whiteElectricBodyShader;
	qhandle_t	whiteElectricBody2Shader;
	qhandle_t	blackElectricBodyShader;
	qhandle_t	blackElectricBody2Shader;
