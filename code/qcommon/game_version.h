...
//TODO See why qcommon/q_version is not found...
#ifdef _DEBUG
#define	JK_VERSION		"(debug)SWGL SP: v" VERSION_STRING_DOTTED
#define	JK_VERSION_OLD		"(debug)SWGL SP: v" VERSION_STRING_DOTTED
#elif defined FINAL_BUILD
#define	JK_VERSION		"SWGL SP: v" VERSION_STRING_DOTTED
#define	JK_VERSION_OLD		"SWGL SP: v" VERSION_STRING_DOTTED
#else
#define	JK_VERSION		"(internal)SWGL SP: v" VERSION_STRING_DOTTED
#define	JK_VERSION_OLD		"(internal)SWGL SP: v" VERSION_STRING_DOTTED
#endif
