...
void CL_DrawDatapad(int HUDType)
{
	...
	case DP_NPC_WEAPON_LABEL:
		...
		break;
	case DP_PLAYER_WEAPON_LABEL_1:
		VM_Call(CG_DRAW_PLAYER_WEAPON_LABEL_1);
		break;
	case DP_PLAYER_WEAPON_LABEL_2:
		VM_Call(CG_DRAW_PLAYER_WEAPON_LABEL_2);
		break;
	case DP_PLAYER_WEAPON_LABEL_3:
		VM_Call(CG_DRAW_PLAYER_WEAPON_LABEL_3);
		break;
	case DP_PLAYER_WEAPON_LABEL_4:
		VM_Call(CG_DRAW_PLAYER_WEAPON_LABEL_4);
		break;
	case DP_PLAYER_WEAPON_LABEL_5:
		VM_Call(CG_DRAW_PLAYER_WEAPON_LABEL_5);
		break;
	case DP_PLAYER_WEAPON_LABEL_6:
		VM_Call(CG_DRAW_PLAYER_WEAPON_LABEL_6);
		break;
	default:
		break;
	}
